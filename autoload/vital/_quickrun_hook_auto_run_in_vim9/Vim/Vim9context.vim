...
execute join(['function! vital#_quickrun_hook_auto_run_in_vim9#Vim#Vim9context#import() abort', printf("return map({'get_context': '', 'get_context_pos': '', '_vital_created': ''}, \"vital#_quickrun_hook_auto_run_in_vim9#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
